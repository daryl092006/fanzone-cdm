...
function normalizeTeamName(name) {
    ...
    if (clean.includes('south korea') || clean.includes('corée du sud') || clean.includes('korea republic')) {
        return 'korea republic';
    }
    if (clean.includes('czech republic') || clean.includes('république tchèque') || clean.includes('rep. tcheque') || clean.includes('czechia')) {
        return 'czechia';
    }
    if (clean.includes('democratic republic of the congo') || clean.includes('rd congo') || clean.includes('dr congo')) {
        return 'dr congo';
    }
    if (clean.includes('united states') || clean.includes('états unis') || clean.includes('etats unis') || clean.includes('usa')) {
        return 'usa';
    }
    if (clean.includes('turkey') || clean.includes('türkiye') || clean.includes('turquie')) {
        return 'türkiye';
    }
    if (clean.includes('bosnia')) {
        return 'bosnia-herzegovina';
    }
    if (clean.includes('ivory coast') || clean.includes('côte d\'ivoire')) {
        return 'ivory coast';
    }
    if (clean.includes('espagne') || clean.includes('spain') || clean.includes('españa')) {
        return 'spain';
    }
    if (clean.includes('belgique') || clean.includes('belgium')) {
        return 'belgium';
    }
    ...
    try {
        ...
        for (const g of apiGames) {
            ...
            if (dbMatch) {
                ...
                console.log(`Unmatched group game: ${g.home_team_name_en} vs ${g.away_team_name_en}`);
            }
        }
